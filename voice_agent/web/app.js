...
(function () {
  ...
  var FIELDS = [
    ...
    { key: 'security.max_same_action', label: '同一操作最多连着问几次（0 = 不限）', type: 'number' },
    ...
    { key: 'agent.subagent_max', label: '同时最多几个子代理（0 = 不限制）', type: 'number' },
    { key: 'agent.subagent_rounds', label: '每个子代理最多做几步（0 = 不限制）', type: 'number' },
