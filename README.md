...
| 🪟 电脑控制   | 44 个内置工具：应用、网址、搜索、音量、媒体、截图、剪贴板、文件读写、通配符查找、内容搜索、打字、快捷键、窗口与进程、锁屏、电源、命令、记忆         |
...
| 🧪 离线可验证  | 15 个测试脚本、538 项断言；含鼠标键盘真窗口点击打字、工具层全量体检、权限闸门、屏幕标记，不接麦克风也能跑完            |
...
| 屏幕标记   | mark_region、mark_point、list_marks、remove_mark、clear_marks                                 |
...
│  │   ├─ builtin.py       47 个内置工具的声明（给模型看的措辞）
